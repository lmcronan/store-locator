	...
	$.extend(Plugin.prototype, {
		...
		processForm: function (e) {
			...
			var _this = this,
				...
				$locationEntered = $('#' + this.settings.searchID),
				$distanceInput = $('#' + this.settings.maxDistanceID),
				region = '';
			...
			if (this.settings.querystringParams === true) {
				...
				if (this.getQueryString(this.settings.addressID) || this.getQueryString(this.settings.searchID) || this.getQueryString(this.settings.maxDistanceID)) {
					...
					$locationEntered = this.getQueryString(this.settings.searchID);
					distance = this.getQueryString(this.settings.maxDistanceID);
			...
			/*
			* initally, the results div is hidden, and will only be shown if the user submits
			*/
			$('.bh-sl-container .bh-sl-loc-list').css('display', 'block');
		},
